    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md anim-up">
        <div className="text-center mb-10">
          ...
          <div className="font-mono text-[10px] text-slate-600 tracking-[2px] mt-2">YOUR TRADING EDGE STARTS HERE</div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-4">
          ...
          <p className="text-center font-mono text-[10px] text-slate-600">
            No account?{' '}
            <Link to="/register" className="text-acc hover:text-acc/80 transition-colors">Register here</Link>
          </p>
        </form>
      </div>
    </div>
